...
# Then, store this value at the output position; here,
...
def interpret(memory, instruction_pointer):
...
part_one_input[1] = 12
part_one_input[2] = 2
print("Part One:", execute(part_one_input))
...
def simulation(verb, noun, memory, target):
    memory[1] = verb
    memory[2] = noun
...
for v in range(0, 100):
    for n in range(0, 100):
        if simulation(v, n, the_input.copy(), 19690720):
            print("Verb/Noun", v, n)
            print("Part Two:", 100 * v + n)
            break
